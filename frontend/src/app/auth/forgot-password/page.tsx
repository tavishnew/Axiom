      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 py-8 sm:px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }} className="w-full max-w-sm">
          ...
          <section className="auth-panel border border-border bg-surface p-6 shadow-[0_20px_40px_-32px_rgba(29,26,24,0.5)] sm:p-8">
            <h1 className="font-serif text-3xl font-normal leading-[0.98] tracking-[-0.04em] text-ink">Reset your password</h1>
            ...
            {submitted ? (
              <div className="mt-6 space-y-4">
                ...
                <a href="/auth/sign-in" className="flex w-full items-center justify-center gap-2 rounded-md bg-accent py-2.5 text-sm font-medium text-white shadow-[0_8px_18px_-12px_rgba(47,96,74,0.34)] transition-colors hover:bg-accent/90">
                  Return to sign in
                </a>
              </div>
            ) : (
